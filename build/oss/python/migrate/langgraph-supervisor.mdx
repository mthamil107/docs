...
| Worker agents added as `StateGraph` nodes | Subagents invoked inside tool functions |
...
| Nested supervisors (`create_supervisor` of supervisors) | Nested tool calls or a custom [`StateGraph`](https://reference.langchain.com/python/langgraph/graph/state/StateGraph) |
