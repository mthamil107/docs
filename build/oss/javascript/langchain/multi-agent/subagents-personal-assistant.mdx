...
<Note>
If you are migrating from the [`langgraph-supervisor`](https://github.com/langchain-ai/langgraph-supervisor-py) package, see [Migrate from langgraph-supervisor](/oss/javascript/migrate/langgraph-supervisor) for before-and-after patterns, including interrupt and resume flows.
</Note>
